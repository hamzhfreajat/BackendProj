...
class FacebookBridge extends BridgeAbstract
{
 ...
 please insert the parameter as follow : myExamplePage/132621766841117';
    ...
    private function collectGroupData()
    {
        ...
        file_put_contents('/app/debug_fetched_fb.html', $html->save());
        $posts = $html->find('div.story_body_container');
        if (!$posts) {
            throwServerException('Failed finding posts! Saved HTML to /app/debug_fetched_fb.html');
        }
