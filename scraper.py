...
async def _async_run_scraper_task(request_data: dict, db: Session):
    ...
    try:
        ...
        system_instruction = (
            ...
            "5. Ensure prices are purely numeric (JOD). IMPORTANT: Daily/monthly apartment rentals can legitimately have a price between 1-99 JOD. However, if the ad is for an ANNUAL rent (سنوي) or SALE (للبيع) and the price is between 1-99 JOD (e.g. '12 JOD'), this is shorthand for thousands! You MUST multiply it by 1000 (e.g. return 12000). DO NOT confuse random numbers ('used 1 month', '99% clean') with a price. If no real monetary price is mentioned, return 0.\\n"
