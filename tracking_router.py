...
import schemas
import jwt
from auth import SECRET_KEY, ALGORITHM, get_current_admin
...
def get_dashboard_insights(db: Session = Depends(get_db), current_admin: models.User = Depends(get_current_admin)):
    # 1. Total Logs
